...
public class OutboxController : Controller
{
    ...
    public OutboxController(ApplicationDbContext db)
    {
        _db = db;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return PartialView("_OutboxTable", new PagedResult<OutboxMessageDto>
        {
            Items = items,
            TotalCount = total,
            Page = page,
    ...
    {
        var item = await _db.OutboxMessages.AsNoTracking()
